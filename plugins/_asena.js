...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'dev ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'dev ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
